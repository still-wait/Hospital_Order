 ...
 */
public class Keshi_select extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        getSupportActionBar().setTitle("选择科室(普通)");
        listview = (ListView) findViewById(R.id.keshi_list_view);
        Adapter = new KeshiAdapter(Keshi_select.this,
        ...
        swipyRefreshLayout.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(SwipyRefreshLayoutDirection direction) {
                List.clear();
                onGetkeshiData(Keshi_select.this,2);
            }
        });
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Keshi_select.this, gh_ordinary.class);
    ...
    private void initData() {
        ...
        if (dialog == null) {
            dialog = new ProgressDialog(Keshi_select.this);
        }
        dialog.setMessage("加载中...");
        dialog.setCancelable(false);
        dialog.show();
        onGetkeshiData(Keshi_select.this,1);
    }
